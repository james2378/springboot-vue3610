...
const routes = [
	...
	//学院信息列表路由
	{
		path: '/college_information/list',
		name: '/college_information_list',
		component: () => import('../views/college_information/list.vue')
	},
	//学院信息详情路由
	{
		path: '/college_information/details',
		name: '/college_information_details',
		component: () => import('../views/college_information/details.vue')
	},
	//课程信息列表路由
	{
...
router.afterEach((to, from, next) => {
	let title = "在线学习网站-home";
	document.title = title;
	document.logo = "在线学习网站"
})
