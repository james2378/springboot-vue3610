<template>
	<div class="diy_details page_college_information" id="college_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_college_information'>
							<div_college_information :obj="obj"></div_college_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_college_information from "@/components/diy/div_college_information.vue";
	import mixin from "@/mixins/page.js";
	export default {
		mixins:[mixin],
		components:{
			div_college_information
		},
		data(){
			return{
		...
		methods:{
			...
			get_collect(obj) {
				...
				var query = {
					...
					source_field: "college_information_id",
					source_id: obj["college_information_id"],
					user_id
				};
		 ...
		 /****
			...
			change_collect() {
				...
				var query = {
					source_table: "college_information",
					source_field: "college_information_id",
					source_id: this.obj["college_information_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/college_information/set?college_information_id=' + _this.obj["college_information_id"], {
								praise_len
							}, (res) => {
								if(res.result){
