<template>
	<div class="diy_details page_course_information" id="course_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_course_information'>
							<div_course_information :obj="obj"></div_course_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_course_information from "@/components/diy/div_course_information.vue";
	import mixin from "@/mixins/page.js";
	export default {
		mixins:[mixin],
		components:{
			div_course_information
		},
		data(){
			return{
