<template>
	<div class="diy_list page_course_information" id="course_information_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">课程信息列表</span>
					</div>
				</div>
				<div class="row diy_list_search">
					<div class="col">
						...
						<div class="view">							
							...
							<b-form-input size="sm" class="mr-sm-2" placeholder="专业搜索" v-model="query['major']" />
							<b-form-input size="sm" class="mr-sm-2" placeholder="教师搜索" v-model="query['teacher']" />
				...
				<div class="diy_list_select_box">
					<span class="diy_list_select_title">下拉搜索：</span>
						...
						<div class="col">
							<!-- 筛选 -->
							<div class="view">
								<b-dropdown text="教师" variant="outline-dark" left>
				...
				<div class="row diy_list_box">
					<div class="col">
						<!-- 列表 -->
						<list_course_information :list="list" />
						<!-- /列表 -->
					</div>
				</div>
...
<script>
	import list_course_information from "@/components/diy/list_course_information.vue";
