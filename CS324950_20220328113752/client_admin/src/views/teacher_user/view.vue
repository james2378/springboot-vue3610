			...
			<el-col v-if="user_group === '管理员' || $check_field('get','post') || $check_field('add','post') || $check_field('set','post')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="职务" prop="post">
					<el-input id="post" v-model="form_sub['post']" placeholder="请输入职务"
							  v-if="user_group === '管理员' || (form_sub['teacher_user_id'] && $check_field('set','post')) || (!form_sub['teacher_user_id'] && $check_field('add','post'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','faculty') || $check_field('add','faculty') || $check_field('set','faculty')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="院系" prop="faculty">
					<el-input id="faculty" v-model="form_sub['faculty']" placeholder="请输入院系"
							  v-if="user_group === '管理员' || (form_sub['teacher_user_id'] && $check_field('set','faculty')) || (!form_sub['teacher_user_id'] && $check_field('add','faculty'))"></el-input>
